import { a as et } from "./rolldown-runtime-WehaI0Q3.js";
import { d as Vt, f as Ht, t as Kt } from "./react-vendor-DBy6KTub.js";
import { c as Jt } from "./ui-vendor-piTSSRQW.js";
import { n as Xt } from "./i18n-D2-4S-fd.js";
var Ro = !!(
    typeof window < "u" &&
    window.document &&
...
var h = Kt();
function Zt(e, t) {
    const r = s.createContext(t),
        n = (a) => {
            const { children: c, ...i } = a,
                d = s.useMemo(() => i, Object.values(i));
            return (0, h.jsx)(r.Provider, { value: d, children: c });
        };
    n.displayName = e + "Provider";
    function o(a) {
        const c = s.useContext(r);
        if (c) return c;
...
function Yt(e, t = []) {
    ...
    function n(a, c) {
        ...
        r = [...r, c];
        const l = (p) => {
            const { scope: g, children: b, ...y } = p,
                u = g?.[e]?.[d] || i,
                m = s.useMemo(() => y, Object.values(y));
            return (0, h.jsx)(u.Provider, { value: m, children: b });
        };
    ...
    const o = () => {
        const a = r.map((c) => s.createContext(c));
        return function (i) {
            const d = i?.[e] || a;
            return s.useMemo(
                () => ({ [`__scope${e}`]: { ...i, [e]: d } }),
...
function qt(...e) {
    ...
    const r = () => {
        ...
        return function (a) {
            const c = n.reduce((i, { useScope: d, scopeName: l }) => {
        ...
        r = s.forwardRef((n, o) => {
            ...
            if (d) {
                ...
                return (0, h.jsx)(t, {
                    ...c,
                    ref: o,
                    children: s.isValidElement(l)
                        ? s.cloneElement(l, void 0, f)
                        : null,
                });
            }
            return (0, h.jsx)(t, { ...c, ref: o, children: a });
        });
    ...
    const t = s.forwardRef((r, n) => {
        ...
        if (s.isValidElement(o)) {
            const c = or(o),
                i = nr(a, o.props);
            return (
                o.type !== s.Fragment && (i.ref = n ? ke(n, c) : c),
                s.cloneElement(o, i)
            );
        }
...
function ir(e, t = globalThis?.document) {
    const r = ee(e);
    s.useEffect(() => {
        const n = (o) => {
            o.key === "Escape" && r(o);
...
var sr = "DismissableLayer",
    Me = "dismissableLayer.update",
    ...
    Ne = s.forwardRef((e, t) => {
        const {
            ...
            P = dr((C) => {
                const O = C.target,
                    N = [...l.branches].some((I) => I.contains(O));
                !w || N || (o?.(C), c?.(C), C.defaultPrevented || i?.());
            }, g),
            k = fr((C) => {
                const O = C.target;
                [...l.branches].some((N) => N.contains(O)) ||
                    (a?.(C), c?.(C), C.defaultPrevented || i?.());
            }, g);
        return (
            ir((C) => {
                S === l.layers.size - 1 &&
            ...
            s.useEffect(() => {
                const C = () => b({});
                return (
                    document.addEventListener(Me, C),
                    () => document.removeEventListener(Me, C)
                );
            }, []),
            (0, h.jsx)(L.div, {
                ...d,
    ...
    return (
        s.useEffect(() => {
            const o = (a) => {
                a.target &&
                    !n.current &&
                    ot(lr, r, { originalEvent: a }, { discrete: !1 });
            };
            return (
...
function ot(e, t, r, { discrete: n }) {
    const o = r.originalEvent.target,
        a = new CustomEvent(e, { bubbles: !1, cancelable: !0, detail: r });
    (t && o.addEventListener(e, t, { once: !0 }),
        n ? ar(o, a) : o.dispatchEvent(a));
}
var Po = Ne,
    ko = nt,
    te = globalThis?.document ? s.useLayoutEffect : () => {},
    pr = "Portal",
    at = s.forwardRef((e, t) => {
        ...
        return c
            ? tt.createPortal((0, h.jsx)(L.div, { ...n, ref: t }), c)
            : null;
    });
at.displayName = pr;
function mr(e, t) {
    ...
    return (
        ...
        te(() => {
            ...
            if (l !== e) {
                ...
                (e
                    ? i("MOUNT")
                    : p === "none" || d?.display === "none"
                      ? i("UNMOUNT")
                      : i(l && f !== p ? "ANIMATION_OUT" : "UNMOUNT"),
                    (o.current = e));
            }
        }, [e, i]),
        te(() => {
            if (t) {
                ...
                const l = t.ownerDocument.defaultView ?? window,
                    f = (g) => {
                        const b = oe(n.current).includes(
                            CSS.escape(g.animationName),
                        );
                        if (
                            g.target === t &&
                            b &&
                            (i("ANIMATION_END"), !o.current)
                        ) {
                    ...
                    p = (g) => {
                        g.target === t && (a.current = oe(n.current));
                    };
                return (
...
var vr = s[" useInsertionEffect ".trim().toString()] || te;
function br({ prop: e, defaultProp: t, onChange: r = () => {}, caller: n }) {
    const [o, a, c] = yr({ defaultProp: t, onChange: r }),
        i = e !== void 0,
        d = i ? e : o;
    {
...
function yr({ defaultProp: e, onChange: t }) {
...
var Te = "-",
    ...
    Er = (e) => {
        ...
        return (
            Rr(Object.entries(e.classGroups), r).forEach(([o, a]) => {
                Re(a, n, o, t);
            }),
            n
        );
            ...
            ? e.map(([r, n]) => [
                  ...
                  n.map((o) =>
                      typeof o == "string"
                          ...
                          : typeof o == "object"
                            ? Object.fromEntries(
                                  Object.entries(o).map(([a, c]) => [t + a, c]),
                              )
                            : o,
                  ),
              ])
        ...
        const { separator: t, experimentalParseClassName: r } = e,
            ...
            c = (i) => {
                ...
                for (let y = 0; y < i.length; y++) {
                    let u = i[y];
                    if (l === 0) {
                        if (u === o && (n || i.slice(y, y + a) === t)) {
                            (d.push(i.slice(f, y)), (f = y + a));
                            continue;
                        }
                        if (u === "/") {
                            p = y;
                ...
                const g = d.length === 0 ? i : i.substring(f),
                    b = g.startsWith(ct);
                return {
                    modifiers: d,
                    hasImportantModifier: b,
                    baseClassName: b ? g.substring(1) : g,
                    maybePostfixModifierPosition: p && p > f ? p - f : void 0,
                };
            };
        return r ? (i) => r({ className: i, parseClassName: c }) : c;
    },
    Nr = (e) => {
    ...
    Tr = (e) => ({ cache: Pr(e.cacheSize), parseClassName: kr(e), ...Sr(e) }),
    Ir = /\s+/,
    Ar = (e, t) => {
        const {
                parseClassName: r,
...
var M = (e) => {
    ...
    qr = () => {
        const e = M("colors"),
            ...
            y = M("gradientColorStopPositions"),
            u = M("inset"),
            m = M("margin"),
            x = M("opacity"),
            S = M("padding"),
        ...
        return {
            ...
            theme: {
                ...
                gradientColorStopPositions: [Br, _],
                inset: G(),
                margin: G(),
                opacity: D(),
                padding: R(),
            ...
            classGroups: {
                ...
                grow: [{ grow: Z() }],
                shrink: [{ shrink: Z() }],
                order: [{ order: ["first", "last", "none", Y, v] }],
                "grid-cols": [{ "grid-cols": [q] }],
                "col-start-end": [
                    { col: ["auto", { span: ["full", Y, v] }, v] },
                ],
                "col-start": [{ "col-start": re() }],
                "col-end": [{ "col-end": re() }],
                "grid-rows": [{ "grid-rows": [q] }],
                "row-start-end": [{ row: ["auto", { span: [Y, v] }, v] }],
                ...
                "gap-x": [{ "gap-x": [g] }],
                "gap-y": [{ "gap-y": [g] }],
                "justify-content": [{ justify: ["normal", ...ge()] }],
                "justify-items": [
                ...
                "align-content": [{ content: ["normal", ...ge(), "baseline"] }],
                "align-items": [
                    {
                        items: [
                            "start",
                ...
                "place-content": [{ "place-content": [...ge(), "baseline"] }],
                "place-items": [
                    {
                        "place-items": [
                            "start",
                ...
                "line-clamp": [{ "line-clamp": ["none", J, he] }],
                leading: [
                    {
                        leading: [
                            "none",
                ...
                "text-decoration-thickness": [
                    { decoration: ["auto", "from-font", j, _] },
                ],
                "underline-offset": [{ "underline-offset": ["auto", j, v] }],
                ...
                "bg-size": [{ bg: ["auto", "cover", "contain", Gr] }],
                "bg-image": [
                    {
                        bg: [
                            "none",
                ...
                "border-style": [{ border: [...ne(), "hidden"] }],
                "divide-x": [{ "divide-x": [i] }],
                "divide-x-reverse": ["divide-x-reverse"],
                "divide-y": [{ "divide-y": [i] }],
                "divide-y-reverse": ["divide-y-reverse"],
                "divide-opacity": [{ "divide-opacity": [x] }],
                "divide-style": [{ divide: ne() }],
                ...
                "outline-style": [{ outline: ["", ...ne()] }],
                "outline-offset": [{ "outline-offset": [j, v] }],
                "outline-w": [{ outline: [j, _] }],
                "outline-color": [{ outline: [e] }],
                "ring-w": [{ ring: De() }],
                "ring-w-inset": ["ring-inset"],
                "ring-color": [{ ring: [e] }],
                "ring-opacity": [{ "ring-opacity": [x] }],
                "ring-offset-w": [{ "ring-offset": [j, _] }],
                "ring-offset-color": [{ "ring-offset": [e] }],
                shadow: [{ shadow: ["", "inner", "none", F, Jr] }],
                ...
                contrast: [{ contrast: [d] }],
                "drop-shadow": [{ "drop-shadow": ["", "none", F, v] }],
...
var en = s[" useId ".trim().toString()] || (() => {}),
    tn = 0;
function ve(e) {
    const [t, r] = s.useState(en());
    return (
        te(() => {
            e || r((n) => n ?? String(tn++));
        }, [e]),
...
var No = [
    ...
    be = "focusScope.autoFocusOnMount",
        ...
        (s.useEffect(() => {
            if (n) {
                let u = function (E) {
                    ...
                    m = function (E) {
                        ...
                        w !== null &&
                            (i.contains(w) || W(p.current, { select: !0 }));
                    },
                    x = function (E) {
                        if (document.activeElement === document.body)
                            for (const w of E)
                                w.removedNodes.length > 0 && W(i);
                    };
            ...
            s.useEffect(() => {
                if (i) {
                    ...
                    if (!i.contains(u)) {
                        const m = new CustomEvent(be, $e);
                        (i.addEventListener(be, l),
                            i.dispatchEvent(m),
                            m.defaultPrevented ||
                                (nn(ln(pt(i)), { select: !0 }),
                                document.activeElement === u && W(i)));
                    }
                    return () => {
                        (i.removeEventListener(be, l),
                            setTimeout(() => {
                                const m = new CustomEvent(ye, $e);
                                (i.addEventListener(ye, f),
                                    i.dispatchEvent(m),
                                    m.defaultPrevented ||
                                        W(u ?? document.body, { select: !0 }),
                                    i.removeEventListener(ye, f),
                                    Ve.remove(b));
                            }, 0));
                    };
                }
        ...
        const y = s.useCallback(
            (u) => {
                ...
                if (m && x) {
                    ...
                    E && w
                        ? !u.shiftKey && x === w
                            ? (u.preventDefault(), r && W(E, { select: !0 }))
                            : u.shiftKey &&
                              x === E &&
                              (u.preventDefault(), r && W(w, { select: !0 }))
                        : x === S && u.preventDefault();
                }
            },
            [r, n, b.paused],
        );
        return (0, h.jsx)(L.div, { tabIndex: -1, ...c, ref: g, onKeyDown: y });
    });
ft.displayName = rn;
function nn(e, { select: t = !1 } = {}) {
    const r = document.activeElement;
    for (const n of e)
        if ((W(n, { select: t }), document.activeElement !== r)) return;
}
function on(e) {
    const t = pt(e);
...
function Ge(e, t) {
    for (const r of e) if (!an(r, { upTo: t })) return r;
}
...
function W(e, { select: t = !1 } = {}) {
    if (e && e.focus) {
        const r = document.activeElement;
        (e.focus({ preventScroll: !0 }), e !== r && sn(e) && t && e.select());
    }
}
var Ve = cn();
function cn() {
    ...
    return {
        add(t) {
            const r = e[0];
            (t !== r && r?.pause(), (e = He(e, t)), e.unshift(t));
        },
        remove(t) {
            ((e = He(e, t)), e[0]?.resume());
        },
...
function un() {
    s.useEffect(() => {
        ...
        return (
            document.body.insertAdjacentElement("afterbegin", e[0] ?? Ke()),
            document.body.insertAdjacentElement("beforeend", e[1] ?? Ke()),
            we++,
            () => {
                (we === 1 &&
                    document
...
var gn = typeof window < "u" ? s.useLayoutEffect : s.useEffect,
    Je = new WeakMap();
function hn(e, t) {
...
var ht = yn(),
    ...
    pe = s.forwardRef(function (e, t) {
        ...
        return s.createElement(
            ...
            c
                ? s.cloneElement(s.Children.only(i), A(A({}, C), { ref: k }))
                : s.createElement(S, A({}, C, { className: d, ref: k }), i),
        );
    });
pe.defaultProps = { enabled: !0, removeScrollBar: !0, inert: !1 };
pe.classNames = { fullWidth: ue, zeroRight: le };
var Xe,
    xn = function () {
        if (Xe) return Xe;
...
`,
    ...
    An = function () {
        s.useEffect(function () {
            return (
                document.body.setAttribute(Q, (Ze() + 1).toString()),
                function () {
                    var e = Ze() - 1;
                    e <= 0
...
var V = Pe ? { passive: !1 } : !1,
    ...
    bt = function (e, t) {
        ...
        return (
            r[t] !== "hidden" &&
            !(r.overflowY === r.overflowX && !Dn(e) && r[t] === "visible")
        );
    },
    jn = function (e) {
    ...
    yt = function (e, t) {
        return e === "v" ? jn(t) : Ln(t);
    },
    wt = function (e, t) {
        return e === "v" ? _n(t) : Fn(t);
    },
    Wn = function (e, t) {
    ...
    zn = function (e, t, r, n, o) {
        ...
        return (
            ((f && ((o && Math.abs(p) < 1) || (!o && c > p))) ||
                (!f && ((o && Math.abs(g) < 1) || (!o && -c > g)))) &&
                (l = !0),
            l
        );
    },
...
function Gn(e) {
    ...
    var i = s.useCallback(function (u, m) {
            if (
            ...
            var x = ie(u),
                S = r.current,
                E = "deltaX" in u ? u.deltaX : S[0] - x[0],
                w = "deltaY" in u ? u.deltaY : S[1] - x[1],
                P,
                k = u.target,
                C = Math.abs(E) > Math.abs(w) ? "h" : "v";
            if ("touches" in u && C === "h" && k.type === "range") return !1;
            ...
            if (
                ...
                return !0;
            var G = n.current || P;
            return zn(G, m, u, G === "h" ? E : w, !0);
        }, []),
        d = s.useCallback(function (u) {
            var m = u;
            if (!(!H.length || H[H.length - 1] !== a)) {
                var x = "deltaY" in m ? qe(m) : ie(m),
                    S = t.current.filter(function (w) {
                        return (
                            w.name === m.type &&
                            (w.target === m.target ||
                                m.target === w.shadowParent) &&
                            Un(w.delta, x)
                        );
                    })[0];
                if (S && S.should) {
                ...
                if (!S) {
                    var E = (c.current.shards || [])
                        ...
                        .filter(Boolean)
                        .filter(function (w) {
                            return w.contains(m.target);
                        });
                    (E.length > 0 ? i(m, E[0]) : !c.current.noIsolation) &&
                        m.cancelable &&
                        m.preventDefault();
                }
            }
        }, []),
        l = s.useCallback(function (u, m, x, S) {
            var E = {
                name: u,
                delta: m,
                target: x,
        ...
        f = s.useCallback(function (u) {
            ((r.current = ie(u)), (n.current = void 0));
        }, []),
        p = s.useCallback(function (u) {
            l(u.type, qe(u), u.target, i(u, e.lockRef.current));
        }, []),
        g = s.useCallback(function (u) {
            l(u.type, ie(u), u.target, i(u, e.lockRef.current));
        }, []);
    s.useEffect(function () {
        return (
            H.push(a),
            ...
            document.addEventListener("wheel", d, V),
            document.addEventListener("touchmove", d, V),
            document.addEventListener("touchstart", f, V),
            function () {
                ((H = H.filter(function (u) {
                    return u !== a;
                })),
                    document.removeEventListener("wheel", d, V),
                    document.removeEventListener("touchmove", d, V),
    ...
    return s.createElement(
        s.Fragment,
        null,
        y ? s.createElement(a, { styles: Bn(o) }) : null,
        b
            ? s.createElement(On, {
...
var Hn = wn(ht, Gn),
    xt = s.forwardRef(function (e, t) {
        return s.createElement(pe, A({}, e, { ref: t, sideCar: Hn }));
    });
xt.classNames = pe.classNames;
var Kn = function (e) {
    ...
    Xn = function (e, t, r, n) {
        var o = Jn(t, Array.isArray(e) ? e : [e]);
        ce[r] || (ce[r] = new WeakMap());
        var a = ce[r],
            c = [],
            i = new Set(),
            d = new Set(o),
                    ...
                    if (i.has(g)) f(g);
                        ...
                        try {
                            ...
                            (K.set(g, u),
                                ...
                                c.push(g),
                                u === 1 && y && se.set(g, !0),
                                m === 1 && g.setAttribute(r, "true"),
                                y || g.setAttribute(n, "true"));
                        } catch (x) {
                            console.error(
        ...
        return (
            ...
            function () {
                (c.forEach(function (p) {
                    ...
                    (K.set(p, g),
                        a.set(p, b),
                        g || (se.has(p) || p.removeAttribute(n), se.delete(p)),
                        b || p.removeAttribute(r));
                }),
                    Ee--,
                    Ee ||
                        ((K = new WeakMap()),
...
var de = "DialogOverlay",
    kt = s.forwardRef((e, t) => {
        const r = Rt(de, e.__scopeDialog),
            { forceMount: n = r.forceMount, ...o } = e,
            a = T(de, e.__scopeDialog);
        return a.modal
            ? (0, h.jsx)(fe, {
                  present: n || a.open,
                  children: (0, h.jsx)(so, { ...o, ref: t }),
              })
            : null;
    });
kt.displayName = de;
var io = Yn("DialogOverlay.RemoveScroll"),
    so = s.forwardRef((e, t) => {
        const { __scopeDialog: r, ...n } = e,
            o = T(de, r);
        return (0, h.jsx)(xt, {
    ...
    U = "DialogContent",
    Nt = s.forwardRef((e, t) => {
        const r = Rt(U, e.__scopeDialog),
            { forceMount: n = r.forceMount, ...o } = e,
            a = T(U, e.__scopeDialog);
        return (0, h.jsx)(fe, {
            present: n || a.open,
            children: a.modal
                ? (0, h.jsx)(co, { ...o, ref: t })
...
Nt.displayName = U;
var co = s.forwardRef((e, t) => {
        const r = T(U, e.__scopeDialog),
            n = s.useRef(null),
            o = B(t, r.contentRef, n);
        return (
            s.useEffect(() => {
                const a = n.current;
                if (a) return Zn(a);
    ...
    It = s.forwardRef((e, t) => {
        const { __scopeDialog: r, ...n } = e,
            o = T(Ae, r);
        return (0, h.jsx)(L.h2, { id: o.titleId, ...n, ref: t });
    });
It.displayName = Ae;
var At = "DialogDescription",
    Ot = s.forwardRef((e, t) => {
        const { __scopeDialog: r, ...n } = e,
            o = T(At, r);
        return (0, h.jsx)(L.p, { id: o.descriptionId, ...n, ref: t });
    });
Ot.displayName = At;
var Dt = "DialogClose",
    jt = s.forwardRef((e, t) => {
...
var Lt = "DialogTitleWarning",
    [Io, _t] = Zt(Lt, { contentName: U, titleName: Ae, docsSlug: "dialog" }),
    uo = ({ titleId: e }) => {
        const t = _t(Lt),
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
    ...
    fo = "DialogDescriptionWarning",
    po = ({ contentRef: e, descriptionId: t }) => {
        const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${_t(fo).contentName}}.`;
        return (
            s.useEffect(() => {
...
var go = Pt,
    ...
    Ao = mo;
var ho = go,
    $t = s.forwardRef(({ className: e, ...t }, r) => {
        const { dir: n } = Xt();
        return (0, h.jsx)(Bt, {
            ref: r,
            className: $(
                `absolute top-4 rounded-sm opacity-70 ring-offset-background transition-opacity data-[state=open]:bg-accent data-[state=open]:text-muted-foreground hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none ${n === "rtl" ? "left-4" : "right-4"}`,
                e,
            ),
            ...t,
        });
    });
$t.displayName = Bt.displayName;
var Gt = s.forwardRef(({ className: e, ...t }, r) =>
    (0, h.jsx)(Ft, {
        ref: r,
        className: $(
...
var vo = s.forwardRef(({ className: e, children: t, ...r }, n) =>
    (0, h.jsxs)(ho, {
        children: [
            (0, h.jsx)(Gt, {}),
            (0, h.jsxs)(Wt, {
...
vo.displayName = Wt.displayName;
var bo = ({ className: e, ...t }) =>
    (0, h.jsx)("div", {
        className: $("flex flex-col space-y-1.5 text-center sm:text-left", e),
        ...t,
    });
bo.displayName = "DialogHeader";
var yo = ({ className: e, ...t }) =>
    (0, h.jsx)("div", {
        className: $(
...
yo.displayName = "DialogFooter";
var wo = s.forwardRef(({ className: e, ...t }, r) =>
    (0, h.jsx)(zt, {
        ref: r,
...
wo.displayName = zt.displayName;
var xo = s.forwardRef(({ className: e, ...t }, r) =>
    (0, h.jsx)(Ut, {
        ref: r,
